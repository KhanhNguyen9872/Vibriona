  ...
  return (
    <div className={`md:hidden flex items-center bg-neutral-100 dark:bg-neutral-800 p-1 rounded-full border border-neutral-200 dark:border-neutral-700 ${className}`}>
      <button
        ...
        className={`relative px-3 py-1.5 rounded-full flex items-center gap-1.5 transition-colors ${mobileActiveTab === 'chat' ? 'text-black dark:text-white' : 'text-neutral-500 dark:text-neutral-400'
          }`}
      >
        {mobileActiveTab === 'chat' && (
          <motion.div
            layoutId="activeTab"
            className="absolute inset-0 bg-white dark:bg-neutral-600 rounded-full"
            initial={false}
      ...
      <button
        ...
        className={`relative px-3 py-1.5 rounded-full flex items-center gap-1.5 transition-colors ${mobileActiveTab === 'script' ? 'text-black dark:text-white' : 'text-neutral-500 dark:text-neutral-400'
          }`}
      >
